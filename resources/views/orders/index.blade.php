                ...
                <div class="card-body">
                    <div class="card-title text-end">
                        ...
                        @if (in_array(ACTION_ARRANGE_SHIPMENT, $actions))
                            @can('order.download')
                                <button class="btn btn-purple" id="arrange-shipment-btn"><i class="bi bi-box2"></i>
                                    ...
                                    <tr style="font-size: 0.8rem;">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                @if (Route::is('orders.returned'))
                                                    <button class="btn p-0 px-1 m-1 text-white"
                                                        style="background-color: #006E9B"><i class="bi bi-box-seam"
                                                ...
                                                @if (Route::is('orders.processing'))
                                                    ...
                                                    @endcan
                                                    {{-- @endempty --}}
                                                    <a href="{{ route('orders.change_postcode_view') }}?sales={{ $order->sales_id }}&company={{ $order->company_id }}&current_postcode={{ $order->customer->postcode }}&redirect_to={{ urlencode(url()->full()) }}"
                                                        class="btn btn-warning p-0 px-1 m-1" title="Change Postcode">
                                                ...
                                                @if (Route::is('orders.packing') || Route::is('orders.readyToShip'))
                                                    @can('shipping.cancel')
                                                        @if ($order->shippings->count())
                                                            <button class="btn btn-danger p-0 px-1 m-1 cancel-shipping"
                                                                data-id="{{ $order->id }}"
                                        ...
                                        <td class="text-center">
                                            @unless ($order->duplicate_orders == null)
                                                <div class="badge bg-purple text-wrap"
                                                    onclick="duplicateModal('{{ $order->duplicate_orders }}')"
                                        ...
                                        <td class="text-start">
                                            ...
                                            @if (!last_two_digits_zero($order->customer->postcode))
                                                <a href="{{ route('orders.change_postcode_view') }}?sales={{ $order->sales_id }}&company={{ $order->company_id }}&current_postcode={{ $order->customer->postcode }}&redirect_to={{ urlencode(url()->full()) }}"
                                                    class="badge bg-warning text-wrap text-dark">
                                        ...
                                        <td>
                                            ...
                                            <span
                                                class="badge small-text {{ $order->payment_refund > 0 ? 'bg-danger' : 'text-danger' }}"
                                                title="Total Refund">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-start">
                    ...
                    <span>Download sample CSV file <a
                            href="https://bosemzi.com/document/template/template_add_tracking_new.csv">here</a></span>
                </div>
            </div>
        </div>
                ...
                <form id="upload" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row mx-5 mb-3">
                            <div class="col">
                                <div id="good-cond" class="border mx-3 text-center p-4" role="button"
                                    onclick="parcel_cond(1)">
                                    Good
                                </div>
                            </div>
                            <div class="col">
                                <div id="bad-cond" class="border mx-3 text-center p-4" role="button"
                                    onclick="parcel_cond(0)">
                                    Defect
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="claim_type" id="claim_type" class="form-control"
                                            onchange="claim_type_click(this)">
                                            <option value="1">Product</option>
                                            <option value="2">Courier Cost</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="claim_from" class="form-label ms-2"><strong>Claim
                                                From</strong></label>
                                    ...
                                    <div class="mb-3">
                                        <label for="claim_note" class="form-label ms-2"><strong>Claim
                                                Note</strong></label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary"
                                onclick="parcel_cond_submit()">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <form action="" id="submit-open-bucket-category">
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <div class="pt-3 pb-3">
                            <p class="fw-bold" style="font-size: 20px;" for="category-id">Please select bucket
                                Category!</p>
                            <div style="display: flex ;justify-content: center;">
                                <select onchange="selectCategory(this)" class="form-select" id="category-id"
                                    name="category_id" style="width: 80%" data-live-search="true">
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-4 text-center pb-2">
                                    <button type="button" class="btn btn-lg btn-outline-dark custom-btn-width"
                                        disabled>
                                        <span style="font-size: 16px;">
                                            TOTAL ORDER: <span id="totalOrderPending"
                                ...
                                <div class="col-12 col-md-4 text-center pb-2">
                                    <button type="button" class="btn btn-lg btn-outline-dark custom-btn-width"
                                        disabled>
                                        <span style="font-size: 16px;">
                                            REMAINING ORDER: <span id="remainingOrderPending"
                                                class="fw-bold text-dark">0</span>
                                        </span>
                                    </button>
                                </div>
                                <div class="col-12 col-md-4 text-center pb-2">
                                    <button type="button" onclick="distribute()"
                                        class="btn btn-lg btn-teal custom-btn-width">
    ...
    <x-slot name="script">
        <script>
            ...
            const removeOldTicked = (checkbox) => {
                ...
                const attachmentElement = document.querySelector(`#attachment-${orderId}`);
                const bucketElement = document.querySelector(`#bucket-${orderId}`);

                if (checkbox.checked) {
                    checkedOrder.push({ 
                        orderId: orderId, 
                        attachment: attachmentElement.value, 
            ...
            const constantNumber = (el) => {
                ...
                let tickedBucket = el.parentElement.parentElement.parentElement.querySelector(
            ...
            const distribute = () => {
                ...
                buckets.forEach(bucket => {
                    if (bucket.parentElement.parentElement.parentElement.querySelector('input[type="checkbox"]')
                        .checked) {
            ...
            const validationInputBucket = (el) => {
                let remainingOrder = parseInt(document.querySelector('#remainingOrderPending').innerHTML);
                if (remainingOrder < 0) {
                    el.parentElement.parentElement.parentElement.querySelector('input[type="number"]').style.borderColor =
                        'red'; //set border color red
                    document.querySelector('#submit-proceed-bucket-button').disabled = true; //disable submit button
                } else {
                    el.parentElement.parentElement.parentElement.querySelector('input[type="number"]').style.borderColor =
                        '#ced4da'; // reset border color
            ...
            const tickBucket = (el) => {
                if (!el.checked) {
                    ...
                    let remainingOrder = document.querySelector('#remainingOrderPending').innerHTML;
                    document.querySelector('#remainingOrderPending').innerHTML = parseInt(remainingOrder) + parseInt(el
                        .parentElement.parentElement.parentElement.querySelector('input[type="number"]').value);
                    //reset value after untick
                    el.parentElement.parentElement.parentElement.querySelector('input[type="number"]').value = 0;
                    el.parentElement.parentElement.parentElement.querySelector('input[type="number"]').setAttribute(
                        'data-value', 0);
                } else {
            ...
            @if (in_array(ACTION_GENERATE_CN, $actions))
                ...
                const conformationDownloadCN = (type, checkedValue) => {
                    ...
                    Swal.fire({
                        ...
                        html: `<p class="text-secondary" style="font-size:0.75rem">You are about to generate shipping label for ${checkedValue} order(s)</p><label style="font-size:0.8rem"><input type="checkbox" name="inc_packing_list_generated_cn" id="inc-packing-list-generated-cn" checked> <span class="ms-2" for="inc-packing-list">Include packing list</span></label>`,
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#3085d6',
                        ...
                        let inc_packing_list_check = document.getElementById('inc-packing-list-generated-cn')
                            .checked;
                        if (result.isConfirmed) {
                            Swal.fire({
                                title: 'Please select courier!',
                            ...
                            generateCN(type, inc_packing_list_check);
                        }
                    })
                }
            @endif
            ...
            async function generateCN(type, inc_packing_list_result) {
                //show loading modal
                Swal.fire({
            ...
            // request CN
            const requestCN = (type, checkedOrder, inc_packing_list_result) => {
            ...
            function download_cn(checkedOrder, inc_packing_list_result) {
                axios({
                    ...
                    .then(function(res) {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            html: `<div>${inc_packing_list_result ? 'Download Request CN and Packing List Successful':'Download Request CN Successful'}.</div>
                ...
                for (let i = 0; i < el.files.length; i++) {
                    ...
                    reader.onload = function(e) {
                        ...
                        photo.insertAdjacentHTML('beforeend',
                            `<img src='${e.target.result}' class="img-fluid img-thumbnail img-50" />`);
                    }
            ...
            document.querySelector('#generate-packing-btn').onclick = function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        let invalidAttachments = checkedOrder.filter(order => order.attachment === '').map(order => order.orderId);
                        let invalidBuckets = checkedOrder.filter(order => order.bucket === '').map(order => order.orderId);
                        ...
                        if (invalidAttachments.length > 0) {
                            ...
                            return;
                        } else if (invalidBuckets.length > 0) {
                            Swal.fire({
                                title: 'Error!',
