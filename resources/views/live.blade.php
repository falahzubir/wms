        ...
        <div class="cards row mb-5">
            <div class="col-4 pe-4">
                <div class="card info-card position-relative" role="button" style="background-color: #EE855B;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" class="icon-clock-first"><path fill="currentColor" d="M12 2A10 10 0 0 0 2 12a10 10 0 0 0 10 10a10 10 0 0 0 10-10A10 10 0 0 0 12 2m4.2 14.2L11 13V7h1.5v5.2l4.5 2.7l-.8 1.3Z"/></svg>
                    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" class="icon-path-position"><path fill="currentColor" d="M20.23 7.24L12 12L3.77 7.24a1.98 1.98 0 0 1 .7-.71L11 2.76c.62-.35 1.38-.35 2 0l6.53 3.77c.29.173.531.418.7.71z" opacity=".25"/><path fill="currentColor" d="M12 12v9.5a2.09 2.09 0 0 1-.91-.21L4.5 17.48a2.003 2.003 0 0 1-1-1.73v-7.5a2.06 2.06 0 0 1 .27-1.01L12 12z" opacity=".5"/><path fill="currentColor" d="M20.5 8.25v7.5a2.003 2.003 0 0 1-1 1.73l-6.62 3.82c-.275.13-.576.198-.88.2V12l8.23-4.76c.175.308.268.656.27 1.01z"/></svg>
                    ...
                    data_scans.forEach((item, index) => {
                        ...
                        <div class="d-flex performance-month justify-content-between mb-2 mt-3">
                                <div class="d-flex align-items-center gap-2 w-100">
                                    <div>
                                        <img src="/assets/img/temp/${item.img}" class="img-fluid"
                                            alt="">
                                    </div>
