    ...
    public function ninjavan_international($order_ids)
    {
        ...
        foreach ($order_ninja as $key => $order) {
            ...
            if (isset($trackingNumber)) {
                ...
                $generateWayBill = $this->retry(function() use ($trackingNumber, $order) {
                    return NinjaVanInternationalTrait::generateWayBill($trackingNumber, $order->company->id);
                }, 5, 60); // Retry up to 5 times with a 60 second interval
